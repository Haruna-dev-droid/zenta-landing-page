...
import { Home, Instagram, Twitter, Facebook, Linkedin, ArrowUpRight } from 'lucide-react'
...
const COLUMNS = [
  ...
  {
    title: 'Support',
    links: ['Help center', 'Contact us', 'Cancellation options', 'Trust & safety'],
  },
  {
    title: 'Company',
    ...
    <footer className="relative overflow-hidden bg-gradient-to-b from-[#f2faf8] to-[#d5ffec] pt-24 pb-10">
      ...
      <div className="relative max-w-[1520px] mx-auto px-8 md:px-12 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_1fr_1fr_1fr_1.2fr] gap-12 md:gap-8 pb-16 border-b border-forest/15">
          <div>
            <a href="#top" className="flex items-center gap-2 w-fit" data-cursor-hover>
            ...
            <p className="mt-5 text-forest/80 max-w-xs leading-relaxed">
              Thousands of stays. Flexible booking. Made for you — wherever you're going, feel at home.
            </p>
            ...
            <div className="mt-6 flex items-center gap-3">
              {SOCIALS.map(({ icon: Icon, label }) => (
                <motion.a
                  ...
                  href="#"
                  aria-label={label}
                  whileHover={{ y: -4, backgroundColor: '#00ea80', color: '#004238' }}
          ...
          {COLUMNS.map((col) => (
            <div key={col.title}>
              <h4 className="font-display text-forest font-semibold text-lg mb-4">{col.title}</h4>
          ...
          <div>
            <h4 className="font-display text-forest font-semibold text-lg mb-4">Stay in the loop</h4>
            <p className="text-forest/75 mb-4">New stays and better deals, straight to your inbox.</p>
            <form
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-forest/60">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="hover:text-forest transition-colors" data-cursor-hover>
              Privacy Policy
            </a>
            <a href="#" className="hover:text-forest transition-colors" data-cursor-hover>
              Terms of Service
